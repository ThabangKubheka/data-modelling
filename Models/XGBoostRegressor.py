...
bbd_bank_model_xgb = xgb.XGBRegressor(random_state=1)
bbd_bank_model_xgb.fit(X_train, y_train)

# Visualize one of the trees in the XGBoost model
# Let's choose the first tree (index 0)
plt.figure(figsize=(12, 8))
xgb.plot_tree(bbd_bank_model_xgb, num_trees=0)
plt.show()
